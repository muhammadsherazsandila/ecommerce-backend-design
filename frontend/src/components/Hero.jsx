  ...
  return (
    <section className="bg-white border border-shade-border rounded-lg mt-6 overflow-hidden">
      <div className="flex flex-col md:flex-row p-4 gap-4 h-auto md:h-[400px]">
        ...
        <div className="w-full md:w-64 flex-shrink-0 overflow-y-auto no-scrollbar">
          {loading ? (
            ...
            <ul className="space-y-0.5">
              {categories.map((cat, index) => (
                ...
                >
                  ...
                  <ChevronRight
                    size={14}
                    className={`opacity-0 group-hover:opacity-100 transition-opacity ${index === activeCategory ? "opacity-100" : ""}`}
                  />
                </li>
              ))}
            </ul>
        ...
        {/* Main Banner */}
        <div
          className="flex-1 relative rounded-lg p-6 md:p-10 flex flex-col justify-center bg-cover bg-no-repeat bg-center"
